...
#ifndef __AI_HAR_IGN_WSDM_H__
#define __AI_HAR_IGN_WSDM_H__
#pragma once

#include "ai_platform.h"

#define AI_HAR_IGN_WSDM_MODEL_NAME          "har_ign_wsdm"

#define AI_HAR_IGN_WSDM_IN_NUM       (1)
#define AI_HAR_IGN_WSDM_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 24, 3, 1, 1, NULL), \
}
#define AI_HAR_IGN_WSDM_IN_SIZE { \
  (24 * 3 * 1), \
}
#define AI_HAR_IGN_WSDM_IN_1_SIZE  (24 * 3 * 1)
#define AI_HAR_IGN_WSDM_IN_1_SIZE_BYTES  ((24 * 3 * 1) * 4)


#define AI_HAR_IGN_WSDM_OUT_NUM      (1)
#define AI_HAR_IGN_WSDM_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 4, 1, NULL), \
}
#define AI_HAR_IGN_WSDM_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_HAR_IGN_WSDM_OUT_1_SIZE  (1 * 1 * 4)
#define AI_HAR_IGN_WSDM_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup har_ign_wsdm
 ...
 * @ref ai_har_ign_wsdm_create. Both the activations memory buffer 
 ...
 * using @ref ai_har_ign_wsdm_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_HAR_IGN_WSDM_*
 * defines into file @ref har_ign_wsdm.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_har_ign_wsdm_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_HAR_IGN_WSDM_H__*/
