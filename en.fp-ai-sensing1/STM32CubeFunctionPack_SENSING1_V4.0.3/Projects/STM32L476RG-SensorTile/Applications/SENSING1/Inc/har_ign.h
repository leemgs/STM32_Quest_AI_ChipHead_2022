...
#ifndef __AI_HAR_IGN_H__
#define __AI_HAR_IGN_H__
#pragma once

#include "ai_platform.h"

#define AI_HAR_IGN_MODEL_NAME          "har_ign"

#define AI_HAR_IGN_IN_NUM       (1)
#define AI_HAR_IGN_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 24, 3, 1, 1, NULL), \
}
#define AI_HAR_IGN_IN_SIZE { \
  (24 * 3 * 1), \
}
#define AI_HAR_IGN_IN_1_SIZE  (24 * 3 * 1)
#define AI_HAR_IGN_IN_1_SIZE_BYTES  ((24 * 3 * 1) * 4)


#define AI_HAR_IGN_OUT_NUM      (1)
#define AI_HAR_IGN_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 5, 1, NULL), \
}
#define AI_HAR_IGN_OUT_SIZE { \
  (1 * 1 * 5), \
}
#define AI_HAR_IGN_OUT_1_SIZE  (1 * 1 * 5)
#define AI_HAR_IGN_OUT_1_SIZE_BYTES  ((1 * 1 * 5) * 4)
 ...
 * @ref ai_har_ign_create. Both the activations memory buffer 
 ...
 * using @ref ai_har_ign_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_HAR_IGN_*
 * defines into file @ref har_ign.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_har_ign_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_HAR_IGN_H__*/
